...
def follow_up_prompt(info: ProgramInfo, missing: list[str]) -> str:
    ...
    return (
        ...
        f"requirements page. Call collect_program_info on any promising URL.\n\n"
        f"IMPORTANT: always pass school=\"{info.school}\" and program=\"{info.program}\" "
        f"regardless of the page you are fetching — never use a page title as the program name.\n\n"
        f"Then provide a complete answer that includes ALL required fields — "
